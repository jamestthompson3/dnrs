	...
	render() {
		return (
			<Container>
				...
				<InfoBox>
					<p>
					Minkälaisia DNRS-harjoitukset ovat?

					Aivojen muokkaaminen vaatii sinulta sekä aikaa että omistautumista. DVD-materiaali on 14 tunnin
					...
					<p><span><b>Kuinka nopeasti harjoittelu tehoaa?</b></span><br /></p>
